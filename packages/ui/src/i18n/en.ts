export const dict: Record<string, string> = {
  ...
  "ui.sessionInvolvement.title": "Files modified in this session",
  "ui.sessionInvolvement.empty": "No files were modified in this session",
  "ui.sessionInvolvement.line": "L{{line}}",
  "ui.sessionInvolvement.lineRange": "L{{start}}–{{end}}",
  "ui.sessionInvolvement.noLineRanges": "No line changes",
